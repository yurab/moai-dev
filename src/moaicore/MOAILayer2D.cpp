...
void MOAILayer2D::RegisterLuaClass ( MOAILuaState& state ) {
	...
	state.SetField ( -1, "SORT_NONE",					(int) MOAIPartitionResultBuffer::SORT_NONE );
	state.SetField ( -1, "SORT_PRIORITY_ASCENDING",		(int) MOAIPartitionResultBuffer::SORT_PRIORITY_ASCENDING );
	state.SetField ( -1, "SORT_PRIORITY_DESCENDING",	(int) MOAIPartitionResultBuffer::SORT_PRIORITY_DESCENDING );
	state.SetField ( -1, "SORT_X_ASCENDING",			(int) MOAIPartitionResultBuffer::SORT_X_ASCENDING );
	state.SetField ( -1, "SORT_X_DESCENDING",			(int) MOAIPartitionResultBuffer::SORT_X_DESCENDING );
	state.SetField ( -1, "SORT_Y_ASCENDING",			(int) MOAIPartitionResultBuffer::SORT_Y_ASCENDING );
	state.SetField ( -1, "SORT_Y_DESCENDING",			(int) MOAIPartitionResultBuffer::SORT_Y_DESCENDING );
}
